        ...
        listener: (context, state) async {
          if (!state.inputChangedValue && state.codigo.isNotEmpty) {
            Navigator.pushReplacement(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        NuevaConstrasena(child: IngresarContrasena(email: state.email, codigo: state.codigo), appBarTitle: 'Restaurar Contraseña')));
          }
        },
        child: Column(
          children: [
            ...
            CustomElevatedButton(
                ...
                onPressed: () => BlocProvider.of<NuevaConstrasenaBloc>(context)
                    .add(VerificarCodigoEvent(email, '${firstCon.text}${secondCon.text}${thirdCon.text}${fourthCon.text}')))
          ],
        ));
  }
}
