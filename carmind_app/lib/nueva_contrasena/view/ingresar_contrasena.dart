...
class IngresarContrasena extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<NuevaConstrasenaBloc, NuevaContrasenaState>(listener: (context, state) async {
      if (!state.inputChangedValue) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => LoginScreen()));
      }
    }, child: BlocBuilder<NuevaConstrasenaBloc, NuevaContrasenaState>(builder: (context, state) {
      return Form(
          ...
          child: Column(
            children: [
              ...
              CustomInput(
                  ...
                  isPassword: true,
                  validator: state.arePassEquals ? null : (_) => 'Las contraseñas no coinciden'),
              const SizedBox(height: 20),
              CustomInput(
