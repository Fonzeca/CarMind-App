...
class _ApiClient implements ApiClient {
  ...
  Future<TokenLogin> login(email, password, fcmToken) async {
    ...
    final queryParameters = <String, dynamic>{r'username': email, r'password': password, r'FCMToken': fcmToken};
  ...
  Future<void> recuperarContrasena(email) async {
    ...
    final _data = <String, dynamic>{};
    await _dio.fetch<void>(_setStreamType<void>(Options(method: 'POST', headers: _headers, extra: _extra)
        .compose(_dio.options, '/public/usuario/recuperar', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    return null;
  }
  ...
  Future<void> validateRecoverToken(pojo) async {
    ...
    await _dio.fetch<void>(_setStreamType<void>(Options(method: 'POST', headers: _headers, extra: _extra)
        .compose(_dio.options, '/public/usuario/validateRecoverToken', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    return null;
  }
  ...
  Future<void> resetPassword(pojo) async {
    ...
    _data.addAll(pojo.toJson());
    await _dio.fetch<void>(_setStreamType<void>(Options(method: 'POST', headers: _headers, extra: _extra)
        .compose(_dio.options, '/public/usuario/resetPassword', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    return null;
  }
  ...
  Future<void> newPasswordAtFirstLogin(password) async {
    ...
    final _data = <String, dynamic>{};
    await _dio.fetch<void>(_setStreamType<void>(Options(method: 'POST', headers: _headers, extra: _extra)
        .compose(_dio.options, '/usuario/newPassword', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    return null;
  }
  ...
  Future<List<LogEvaluacion>> getLogEvaluacionesByLoggedUser(limit) async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_setStreamType<List<LogEvaluacion>>(Options(method: 'GET', headers: _headers, extra: _extra)
        .compose(_dio.options, '/evaluacion/historial/loggedUser?limit=${limit}', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<VersionView> getLastVersionByPlatform(storeType) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<VersionView>(Options(method: 'GET', headers: _headers, extra: _extra)
        .compose(_dio.options, '/public/lastVersion_new?platform=${storeType}', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<List<VehicleInfoMap>> getAllVehiculos() async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(_setStreamType<List<VehicleInfoMap>>(Options(method: 'GET', headers: _headers, extra: _extra)
        .compose(_dio.options, '/vehiculo', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!.map((dynamic i) => VehicleInfoMap.fromJson(i as Map<String, dynamic>)).toList();
    return value;
  }
  ...
  Future<List<VehicleInfoMap>> getVehiclesTrackinInfo(imeis) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(imeis);
    final _result = await _dio.fetch<List<dynamic>>(_setStreamType<List<VehicleInfoMap>>(Options(method: 'POST', headers: _headers, extra: _extra)
        .compose(_dio.options, '/trackin/getVehiclesStateByImeis', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!.map((dynamic i) => VehicleInfoMap.fromJson(i as Map<String, dynamic>)).toList();
    return value;
  }
  ...
  Future<List<RouteInfo>> getRoute(pojo) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(pojo.toJson());
    final _result = await _dio.fetch<List<dynamic>>(_setStreamType<List<RouteInfo>>(Options(method: 'POST', headers: _headers, extra: _extra)
        .compose(_dio.options, '/trackin/getRouteByImei', queryParameters: queryParameters, data: _data)
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!.map((dynamic i) => RouteInfo.fromJson(i as Map<String, dynamic>)).toList();
    return value;
  }
